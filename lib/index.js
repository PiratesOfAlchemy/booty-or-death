...
const setUsername = async () => {
  inquirer
    ...
    .then((answer) => {
      console.log(chalk.bold(gradient.mind(`Welcome aboard, ${answer.username}`)), ship);
...
const gameLoop = async (gameId, user) => {
  ...
  getPrompts(gameId)
    ...
    .then(() => {
      ...
      console.log(asciiMap[currentPrompts.id]);
...
const startGame = () => gameStart().then(() => setUsername());
startGame();
