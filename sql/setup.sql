...
VALUES 
    ...
    (7, 'A storm''s a-brewing as you''re relaxing below deck. Unfortunately the poor lad who was doing your chores gets thrown overboard.(CHANCE)', 'dive in after them', 'while everyone is distracted, pick the lock to the captain''s cabins', 13, 14, false),
    ...
    (9, 'Give no quarter! You fight violently and enthusiastically, but soon find yourself outmatched by the more seasoned pirates and you''re run through. The worst bit? The bloody mate''s name is Jeff. You were bested by Jeff. {BOOTY}', 'replay', 'quit', 0, 0, null),
    ...
    (11, 'Nice try, but the mighty Drunken Sea Dragon is sunk. Not the GREATEST first day as a pirate. Hope you learned how to swim. {BOOTY}', 'replay', 'quit', 0, 28, null),
    ...
    (13, 'You give it your most valiant effort but die in shark-infested waters. Life be like that sometimes. Maybe you should''ve built more karma up sooner, and you would''ve had better luck. {BOOTY}', 'replay', 'quit', 0, 0, null),
    ...
    (22, 'Surprise! {NAME}, you are hated by everyone on the ship and they aren''t into your idea of mutiny-ing their precious captain. {BOOTY}', 'replay', 'quit', 1, 0, null),

    (23, 'You''ve found the infamous Blackbeard''s treasure!! It''s now up to you how ye see fit to split it amongst the crew. {BOOTY}', 'replay', 'quit', 1, 0, null),
    
    (24, 'You''re rewarded with the best booty (aside treasure itself, a''course); a one-legged parrot name Walki-Talki. And tied around him is a fashionable pearl necklace, yours to do with as you wish {BOOTY}', 'replay', 'quit', 1, 0, null),

    (25, 'As your reward for surviving as pirate, you''re now the proud owner of a beautiful feather to start creating a replica of Captain White Stache''s marvelous hat that you''ve been eye-balling since joining The Drunken Sea Dragon. {BOOTY}', 'replay', 'quit', 1, 0, null),

    (26, 'Drat! You''ve contracted skurvy and the worst news? The teeth don''t go back in! And you might be losing what''s left of your friends, too. Best find ya some oranges, quick as ye can! {BOOTY}', 'replay', 'quit', 1, 0, null),

    (27, 'A cry to ''Walk the plank!'' goes out and you''re forced to the ship''s edge with your hands tied behind your back. How are you going to get out of this one? Hope you''re good at swimming with just your legs. {BOOTY}', 'replay', 'quit', 1, 0, null),
    ...
    (31, 'Just your luck, as you''re deserting White Stache, you spot something gleaming in a distant cove. It''s Blackbeard''s famous treasure and one day in you are the richest Captain alive. {BOOTY}', 'replay', 'quit', 1, 0, null),

    (32, 'As White Stache is sinking to the bottom of the sea, you realize Blackbeard''s infamous treasure map was in his pocket and is now lost forever. At least you get to keep his booty?? {BOOTY}', 'replay', 'quit', 1, 0, null);
